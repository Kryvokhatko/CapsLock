...
export class ReviewsSection {
    ...
    constructor(page: Page) {
        ...
        this.reviewsSection = page.locator('section.background-lightBlue').filter({ hasText: 'See What People Are Saying' });
        ...
        this.dennyReviewCard = page.locator('.review').filter({ hasText: /denny/i }).first();
        // Review installation photo inside Denny's review card (excludes the avatar)
        this.dennyReviewPhotoImage = this.dennyReviewCard.locator('.review__img img');
