...
test.describe('US01: Form #1 - Happy Path', () => {
    test('TC01: Complete all 5 steps with valid data via Form #1 => /thankyou', async ({ stepZip1, stepInterest1, 
stepProperty1, stepContact1, stepPhone1, thankYouPage }) => {
        // Step 1 Enter ZIP
    ...
    test('TC02: Each step shows its own question heading, advancing through all 5 steps', async ({ page, stepZip1, stepInterest1, stepProperty1, stepContact1, stepPhone1 }) => {
