...
test.describe('US04: ZIP Code Validation', () => {
    ...
    test('TC02: 4-digit ZIP => invalid ZIP error (BVA lower boundary)', async ({ stepZip1 }) => {
    ...
    test('TC03: 6-digit ZIP => invalid ZIP error (BVA upper boundary)', async ({ stepZip1 }) => {
    ...
    test('TC04: Non-numeric characters => invalid ZIP error', async ({ stepZip1 }) => {
    ...
    test('TC05: ZIP+4 format => invalid ZIP error (DEF-02)', async ({ stepZip1 }) => {
